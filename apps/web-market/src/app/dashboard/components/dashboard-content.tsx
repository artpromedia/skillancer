...
// Mock data for dashboard - TODO: Replace with real API data
const stats = [
  {
...
export function DashboardContent({ userName, userInitials }: DashboardContentProps) {
  return (
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-gray-600">
            Here is what is happening with your freelancing business.
          </p>
        </div>
