...
export const metadata: Metadata = genMeta({
  ...
  description:
    'Join Skillancer and start your freelance journey. Free to get started, no credit card required.',
  path: '/signup',
});
        ...
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  className="rounded-lg border-2 border-indigo-500 bg-indigo-50 px-4 py-3 font-medium text-indigo-700"
                  type="button"
                >
                  Freelancer
                </button>
                <button
                  className="rounded-lg border-2 border-slate-200 px-4 py-3 font-medium text-slate-700 hover:border-slate-300"
                  type="button"
                >
                  Client
                </button>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 rounded-lg border border-slate-300 px-4 py-2 hover:bg-slate-50">
