 ...
 * Job payment type
 */
export const jobTypeSchema = z.enum(['FIXED_PRICE', 'HOURLY', 'RETAINER', 'MILESTONE']);
export type JobType = z.infer<typeof jobTypeSchema>;

/**
 * Job visibility
 */
export const jobVisibilitySchema = z.enum(['PUBLIC', 'PRIVATE', 'INVITE_ONLY', 'TENANT_ONLY']);
 ...
 * Create job input
 */
export const createJobSchema = baseJobDataSchema
  .extend({
