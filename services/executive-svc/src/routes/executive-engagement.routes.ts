...
export async function executiveEngagementRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/engagements/executive/:executiveProfileId', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/engagements/client/:clientTenantId', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/engagements/:id/terminate', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
      const { reason } = request.body as { reason: string };
  ...
  // Log time entry
  fastify.post('/engagements/:id/time-entries', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
      const input = request.body as any;
  ...
  fastify.get('/engagements/:id/time-entries', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
  ...
  // Create milestone
  fastify.post('/engagements/:id/milestones', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
      const input = request.body as any;
  ...
  fastify.get('/engagements/:id/milestones', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
  ...
  fastify.patch('/milestones/:milestoneId/status', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  // Setup workspace
  fastify.post('/engagements/:id/workspace', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
  ...
  // Get workspace
  fastify.get('/engagements/:id/workspace', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as { id: string };
